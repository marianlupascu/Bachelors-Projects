...
pragEuristicaDeTrecere = 98.5; % completez aleator 98.5% apoi vin liniar exact la la caroiaj
...
switch(params.criteriu)
    case 'aleator'
        ...
        while ok == 1
            ...
            if iteratie > 1000
                % fac calculul de umplere si sfisarile din 1000 in 1000 de
    ...
    case 'distantaCuloareMedie'
        ...
        while ok == 1
            ...
            distEuclid = sum(( params.medieCuloarePieseMozaic - ...
                    ...
                    (i:min([i+H-1, h]),j:min([j + W-1, w]),:)))).^2, 3);
...
% verific daca am umplere completa
