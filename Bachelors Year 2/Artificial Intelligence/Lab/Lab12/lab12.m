...
n = 50;
sigma = 0.5;
Xp = genereazaLiterePerturbate(alphabet(:,1),n,sigma);

% % for i=1:n
% %     figure, imagesc(reshape(Xp(:,i),9,10)');pause(0.1);close all;
% % end
